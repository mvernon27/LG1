export default function Elements(el){
    ...
    <elements>  
        ...
        return `          
                <ele class="ele ${element.class} Group${element.groupId} Period${element.periodId}">
                    ...
                    <input type='hidden' value="${element.image2}">
                    <input type='hidden' value="${element.phase}">
                    <input type='hidden' value="${element.description}">
